              ...
              <div class="w-full  rounded-lg  sm:max-w-md xl:p-0 ">
                <div class=" space-y-4 md:space-y-6 ">
                  ...
                  <form class="space-y-4 md:space-y-6" action="#">
                    <div>
                    <label class="block  text-sm font-medium text-gray-900 dark:text-white">Total Balance : $2500</label>
                    </div>
                    <div>
                    <label class="block  text-sm font-medium text-gray-900 dark:text-white">UPI : 987654321@upi</label>
                    </div>
                    <div>
                      <input
                        type="number"
